...
/**
 * The LowpanConnector connects a server to the network using
 * a special API. So far this is a dummy/example.
 */
public class LowpanConnector extends ConnectorBase {

	private final static Logger LOGGER = CalifonriumLogger.getLogger(LowpanConnector.class);
	...
	public LowpanConnector(EndpointAddress address, NetworkConfig config) {
		super(address);
	...
	public synchronized void start() throws IOException {
		 ...
		 * 1.7.0_09, Windows 7.
		 */
		LOGGER.info("LoWPAN connector listening on "+socket.getLocalSocketAddress()+", recv buf = "+receiveBuffer+", send buf = "+sendBuffer);
	}
