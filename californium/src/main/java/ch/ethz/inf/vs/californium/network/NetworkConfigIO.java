...
import static ch.ethz.inf.vs.californium.network.NetworkConfigIO.Prop.ACK_RANDOM_FACTOR;
import static ch.ethz.inf.vs.californium.network.NetworkConfigIO.Prop.ACK_TIMEOUT;
import static ch.ethz.inf.vs.californium.network.NetworkConfigIO.Prop.DEFAULT_BLOCK_SIZE;
import static ch.ethz.inf.vs.californium.network.NetworkConfigIO.Prop.DEFAULT_LEISURE;
import static ch.ethz.inf.vs.californium.network.NetworkConfigIO.Prop.MARK_AND_SWEEP_INTERVAL;
import static ch.ethz.inf.vs.californium.network.NetworkConfigIO.Prop.MAX_MESSAGE_SIZE;
import static ch.ethz.inf.vs.californium.network.NetworkConfigIO.Prop.MAX_RETRANSMIT;
import static ch.ethz.inf.vs.californium.network.NetworkConfigIO.Prop.NOTIFICATION_MAX_AGE;
import static ch.ethz.inf.vs.californium.network.NetworkConfigIO.Prop.NSTART;
import static ch.ethz.inf.vs.californium.network.NetworkConfigIO.Prop.PROBING_RATE;
